...
@implementation UITextView (PearNumview)
...
- (void)setPlaceHolderLabel:(NSString *)placeholder {
    ...
    self.placeholderLabel.textColor = Gray_color_uibrother;
...
- (void)setWordcountLable:(NSNumber *)limitLength {
     ...
     *  字数限制
     */
    self.wordCountLabel = [[UILabel alloc] initWithFrame:CGRectMake(190, 70, 65, 35)];
